...
const content = {
  ...
  termsAndConditions: {
    ...
    paragraphs: {
      ...
      collectedData: 'We do not store any password-related submitted data; namely the content of the website & password fields, the derived keys, or the options provided the derivation of the keys.\n\nWe do store metadata related to each used, such as the IP address, browser details, time, subpages visited, and bitrate of the incoming connection. This data is only used for analytic and security purposes.',
